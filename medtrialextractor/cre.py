...
class RxnExtractor(object):
    ...
    def load_model(self):
        ...
        if os.path.isdir(prod_model_dir):
            sys.stderr.write(f"Loading ner extractor from {prod_model_dir}...")
    ...
    def get_entities(self, text_list):
        ...
        # create dataset
        examples = []
        for guid, txt in enumerate(text_list):
        ...
        tokenized_texts = [ex.words for ex in examples]
        return tokenized_texts, all_preds
